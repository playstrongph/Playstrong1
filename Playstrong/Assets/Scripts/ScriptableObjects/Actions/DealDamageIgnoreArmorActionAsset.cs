...
{
    [CreateAssetMenu(fileName = "DealDamageIgnoreArmorActionAsset", menuName = "SO's/SkillActions/DealDamageIgnoreArmorActionAsset")]
    
    public class DealDamageIgnoreArmorActionAsset : SkillActionAsset
    {
