...
{
    [CreateAssetMenu(fileName = "DecreaseSpeedBasicAction", menuName = "SO's/BasicActions/D/DecreaseSpeedBasicAction")]
    
    public class DecreaseSpeedBasicActionAsset : BasicActionAsset
    {
