...
{
    [CreateAssetMenu(fileName = "SetSkillCountersToValue", menuName = "SO's/BasicActions/S/SetSkillCountersToValue")]
    
    public class SetSkillCountersToValueBasicActionAsset : BasicActionAsset
    {
        ...
        public override IEnumerator TargetAction(IHero targetHero)
        {
            ...
            {
                _skillToIncreaseCounters.SkillLogic.SkillOtherAttributes.SkillCounters = setValue;
            }
