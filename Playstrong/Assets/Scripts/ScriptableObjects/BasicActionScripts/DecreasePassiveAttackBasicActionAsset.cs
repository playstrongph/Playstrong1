...
{
    [CreateAssetMenu(fileName = "DecreasePassiveAttack", menuName = "SO's/BasicActions/D/DecreasePassiveAttack")]
    
    public class DecreasePassiveAttackBasicActionAsset : BasicActionAsset
    {
