...
{
    [CreateAssetMenu(fileName = "SkillCountersEqualsLimit", menuName = "SO's/BasicConditions/SkillCountersEqualsLimit")]
    
    public class SkillCountersEqualsLimitBasicConditionAsset : BasicConditionAsset
    {
