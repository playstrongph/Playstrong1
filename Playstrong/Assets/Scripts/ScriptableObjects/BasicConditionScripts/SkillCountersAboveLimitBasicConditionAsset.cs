...
{
    [CreateAssetMenu(fileName = "SkillCountersAboveLimit", menuName = "SO's/BasicConditions/SkillCountersAboveLimit")]
    
    public class SkillCountersAboveLimitBasicConditionAsset : BasicConditionAsset
    {
